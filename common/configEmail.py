...
if __name__ == '__main__':
    ...
    m = SendEmail(
        username='605546609@qq.com',
        passwd='aywixscdymttbfgi',
        recv=['haixiang.lu@ly.com'],
        title='测试',
        content='测试发送邮件',
        file=r'D:\MyConfiguration\haixiang.lu\PycharmProjects\lhxTest03\testFile\report\\'+ now + "_result.html",
        ssl=True
    )
    m.send_email()
